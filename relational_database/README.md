...
For this I have developed an all purpose python script that uses a CSV dataframe as input and generates a relational database as output. The usage of the script is as follows:
```
